...
************************************************************************************************************/
	...
	function startSlide(e)
	{
		...
		var id = this.id;
		this.getElementsByTagName('IMG')[0].src = 'adimg/' + this.id + '_over.gif';
	...
	{
		var id = this.id;
		this.getElementsByTagName('IMG')[0].src = 'adimg/' + this.id + '.gif';
		slideSpeed=0;
	}
	...
	function initSlideShow()
	{
		...
		imageGalleryWidth = galleryContainer.offsetWidth - 50;
